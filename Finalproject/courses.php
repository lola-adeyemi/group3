...
<!-- Masthead-->
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <h1 class="masthead-heading text-uppercase mb-0">     Courses</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Avatar Image--><img class="masthead-avatar mb-5 img-fluidpage" src="assets/img/courses.jpg" alt="picture of women" /><!-- Masthead Heading-->
                <p class="masthead-photo font-weight-light mb-0 align-left">&#128155 </p> </div>
        </header> 
<div class="container align-left"><p>Last Updated:  <?php echo $date; ?></p></div>
      <div class="container align-self-center ">
<h4 class="align-items-center text-dark"> Deciding where to begin in your software journey can be overwhelming.
             
    <br>You can use this page to find relevant courses depending on your area of interest. </h4><br></div> 
   <div class="container align-self-center ">        
          <?php
     foreach ($data as $row) 
         {   
       ?>
           <table class="table-borderless align-self-center text-dark">
         <tr> 
             <td class="border-top bg-light font text-dark text-uppercase"> <h6>Name:</h6> <?php echo $row['Name'] ?></td> 
         </tr>
         <tr>
                  <td><h6>Price:</h6> <?php echo $row['Price'] ?></td>
         </tr>
         <tr>
                  <td><h6>Description:</h6> <?php echo $row['Description'] ?></td> 
         </tr>
         <tr>
             <td class="border-bottom"><h6>Link:</h6> <?php echo $row['Link'] ?><br><br></td> 
